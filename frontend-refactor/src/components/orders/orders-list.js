...
export class OrdersList {
  ...
  showRecords(orders) {
    ...
    for (let i = 0; i < orders.length; i++) {
     ...
     const statusInfo = CommonUtils.getOrderStatus(orders[i].status);
      trElement.insertCell().innerHTML = '<span class="badge badge-' + statusInfo.color +'">' + statusInfo.value + '</span>';
